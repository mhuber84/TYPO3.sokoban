...
/**
 * Test case for class Tx_Sokoban_Domain_Model_ContentElement.
 *
 * @version $Id$
 ...
 */
class Tx_Sokoban_Domain_Model_ContentElementTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Sokoban_Domain_Model_ContentElement
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Sokoban_Domain_Model_ContentElement();
	}
